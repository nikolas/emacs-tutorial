...
Emacs has a long history having been in continuous development since 1985. In
...
a key labelled "Meta". Shift is referred to using capital letters. Esc is
...
the perspective of the user, in a graphical environment, minimizing Emacs
